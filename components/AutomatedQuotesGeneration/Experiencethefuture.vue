            ...
            <div class="row justify-content-center">
                <div class="col-lg-6 col-sm-6 col-md-6">
                    <div class="features-item with-border-one">
                        <h3><span class="sub-title-key-features">Automated Document </span> <br>Generation Made Easy </h3>
                ...
                <div class="col-lg-6 col-sm-6 col-md-6">
                    <div class="features-item with-border-three">
                        ...
                        <h3>Achieve 10x Faster <br><span class="sub-title-key-features">Quote Generation</span></h3>
