            ...
            <div class="row justify-content-center">
                <div class="col-lg-6 col-sm-6 col-md-6">
                    <div class="features-item with-border-one">
                        <h3><span class="sub-title-key-features">Easy Modification</span> of Scope</h3>
                ...
                <div class="col-lg-6 col-sm-6 col-md-6">
                    <div class="features-item with-border-two">
                        <h3><span class="sub-title-key-features">Enhanced Rate</span> of Dealing</h3>
                ...
                <div class="col-lg-6 col-sm-6 col-md-6">
                    <div class="features-item with-border-three">
                        <h3>Easy Vendor  <span class="sub-title-key-features">Quoting</span></h3>
                ...
                <div class="col-lg-6 col-sm-6 col-md-6">
                    <div class="features-item with-border-four">
                        <h3><span class="sub-title-key-features">Track</span> Project Versions</h3>
