            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-6 col-sm-6 col-md-6">
                    <div class="features-item with-border-three">
                        ...
                        <p>Experience an incredible 10x speed advancement compared to quotes created in Word and Excel spreadsheets. DealDox - enables automated sales quotes in seconds, regardless of the number of line items.
                        </p>
                    </div>
                </div>
                <div class="col-lg-6 col-sm-6 col-md-6">
