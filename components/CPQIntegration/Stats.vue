    ...
    <div class="key-features-area bg-#FAFAFA pt-100">
        <div class="container">
            <div class="section-titles title-with-bg-text">
                ...
                <p>DealDox is designed to automate the sales quoting process and close more deals with ease and confidence. Our CPQ for Services allows you to generate detailed statements of work, proposals, quotes, and documents swiftly, ensuring lightning-fast speed and unmatched accuracy.                    
                </p>
            </div>
